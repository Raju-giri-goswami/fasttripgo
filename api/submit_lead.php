...
// Log request details
error_log("Lead form submission received: " . date('Y-m-d H:i:s'));
...
try {
    ...
    // Email content
    $mail->isHTML(true);
    $mail->Subject = 'New Lead Form Submission - FastTripGo';
    ...
    // Log before sending
    error_log("Attempting to send lead notification email");
    ...
    // Log success
    error_log("Lead notification email sent successfully");
    ...
    error_log("Lead form error: " . $e->getMessage());
    http_response_code(500);
    echo json_encode([
        "success" => false,
        "error" => "Failed to send message. Technical details: " . $e->getMessage()
    ]);
}
